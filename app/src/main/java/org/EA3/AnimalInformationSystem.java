...
public class AnimalInformationSystem {
  /*
   * * Diese Methode liefert Informationen über die Eigenschaften eines Tiers.
   * Dazu * muss der Name der Tier-Art als erster Parameter der Methode übergeben
   * werden.
   */
  public static void main(String[] args) {
    ...
    // }
    // /* Hier könnten weitere If-Anweisungen für weitere Tierarten stehen. */ if (tier == null) {
